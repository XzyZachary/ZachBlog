        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            ...
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Welcom to ${siteMetadata.description}.I am a Front-End Engineer.In my free time, I like developing. `}
              side projects and learn new technologies.
            </h2>
        ...
        <ul>
          ...
          {posts.slice(0, MAX_DISPLAY).map((frontMatter) => {
            ...
            return (
              <li
                key={slug}
                className="group flex cursor-pointer bg-transparent bg-opacity-20 px-2 py-6 transition duration-100 hover:scale-105 hover:rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                <article>
