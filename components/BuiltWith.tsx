  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      <div className="flex space-x-1.5">
        <Link href="https://nextjs.org?ref=zachary-blog.vercel.app">
          <DevIcon type="NextJS" className="h-5 w-5" />
        </Link>
        <Link href="https://tailwindcss.com?ref=zachary-blog.vercel.app">
          <DevIcon type="TailwindCSS" className="h-5 w-5" />
        </Link>
        <Link href="https://www.prisma.io?ref=zachary-blog.vercel.app">
          <DevIcon type="Prisma" className="h-5 w-5" />
        </Link>
        <Link href="https://www.typescriptlang.org?ref=zachary-blog.vercel.app">
          <DevIcon type="Typescript" className="h-5 w-5" />
        </Link>
        <Link href="https://umami.is?ref=zachary-blog.vercel.app" className="pl-px">
